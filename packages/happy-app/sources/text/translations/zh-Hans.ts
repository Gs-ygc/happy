...
export const zhHans: TranslationStructure = {
    ...
    activity: {
        title: '动态', today: '今天', older: '更早', emptyTitle: '已全部查看',
        emptyDescription: '未读的任务更新会显示在这里，并可直接打开对应会话。', markAllRead: '全部标记为已读', newActivity: '新动态',
    },
    ...
    session: {
        ...
        newChat: '新对话',
        restartCodexAction: '重启 Codex',
        restartCodexTitle: '重启当前 Codex 会话？',
        restartCodexMessage: '这会停止当前任务、重启 Codex 后端，并恢复同一个线程。Happy 会话和消息记录不会改变。',
        restartCodexFailed: 'Codex 会话重启失败。',
