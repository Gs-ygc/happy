...
export const it: TranslationStructure = {
    ...
    activity: {
        title: 'Attività', today: 'Oggi', older: 'Precedenti', emptyTitle: 'Tutto aggiornato',
        emptyDescription: 'Gli aggiornamenti non letti appariranno qui.', markAllRead: 'Segna tutte le attività come lette', newActivity: 'Nuova attività',
    },
    ...
    settingsFeatures: {
        ...
        showThinkingSubtitle: 'Mostra il ragionamento dell’agente in blocchi compressi',
    ...
    session: {
        pin: "Pin to top",
        unpin: "Unpin",
        renameEmpty: 'È necessario un nome per la sessione.',
    ...
    components: {
        ...
        agentGoalBar: {
            ...
            pauseGoal: 'Pausa obiettivo',
            resumeGoal: 'Riprendi obiettivo',
    ...
    taskCenter: {
        ...
        statusIdle: 'Inattivo',
        pending: 'In attesa',
        statusPending: 'In attesa di invio',
        forceSubmit: 'Invia',
