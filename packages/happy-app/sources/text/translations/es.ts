...
export const es: TranslationStructure = {
    ...
    activity: {
        title: 'Actividad', today: 'Hoy', older: 'Anteriores', emptyTitle: 'Todo al día',
        emptyDescription: 'Las actualizaciones no leídas aparecerán aquí.', markAllRead: 'Marcar toda la actividad como leída', newActivity: 'Actividad nueva',
    },
    ...
    settingsFeatures: {
        ...
        showThinkingSubtitle: 'Muestra el razonamiento del agente en bloques contraídos',
    ...
    session: {
        pin: "Pin to top",
        unpin: "Unpin",
        renameEmpty: 'Se necesita un nombre de sesión.',
    ...
    taskCenter: {
        ...
        statusIdle: 'Inactivo',
        pending: 'Pendiente',
        statusPending: 'Pendiente de envío',
        forceSubmit: 'Forzar envío',
