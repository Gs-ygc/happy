...
export const zhHant: TranslationStructure = {
    ...
    settingsFeatures: {
        ...
        showThinking: '顯示思考過程',
        showThinkingSubtitle: '以預設收合的區塊顯示代理程式思考過程',
    ...
    session: {
        pin: '置頂',
        unpin: '取消置頂',
        renameEmpty: '請輸入工作階段名稱。',
        inputPlaceholder: '輸入訊息...',
        inactiveArchived: '此會話處於非活動狀態。',
        resumeFromTerminal: '若要從終端恢復它：',
        newChat: '新對話',
        restartCodexAction: '重新啟動 Codex',
        restartCodexTitle: '重新啟動目前的 Codex 工作階段？',
        restartCodexMessage: '這會停止目前的任務、重新啟動 Codex 後端，並恢復同一個執行緒。Happy 工作階段和訊息記錄不會改變。',
        restartCodexFailed: 'Codex 工作階段重新啟動失敗。',
