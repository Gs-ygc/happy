...
export const pl: TranslationStructure = {
    ...
    activity: {
        title: 'Aktywność', today: 'Dzisiaj', older: 'Starsze', emptyTitle: 'Wszystko nadrobione',
        emptyDescription: 'Nieprzeczytane aktualizacje zadań pojawią się tutaj.', markAllRead: 'Oznacz całą aktywność jako przeczytaną', newActivity: 'Nowa aktywność',
    },
    ...
    settingsFeatures: {
        ...
        showThinking: 'Pokaż tok rozumowania',
        showThinkingSubtitle: 'Wyświetla rozumowanie agenta w zwiniętych blokach',
    ...
    session: {
        pin: "Pin to top",
        unpin: "Unpin",
        renameEmpty: 'Nazwa sesji jest wymagana.',
    ...
    taskCenter: {
        ...
        pending: 'Oczekujące',
        statusPending: 'Oczekuje na wysłanie',
        forceSubmit: 'Wyślij teraz',
